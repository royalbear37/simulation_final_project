...
def simulate_idle_time(area_machines, num_staff, simulation_time, dispatch_rule='fifo'):
    """
...
def total_idle_time(allocation, sim_time, dispatch_rule='FIFO'):
    e_idle = simulate_idle_time(ETCH_machines, allocation[0], sim_time, dispatch_rule=dispatch_rule)
    p_idle = simulate_idle_time(PHOTO_machines, allocation[1], sim_time, dispatch_rule=dispatch_rule)
    t_idle = simulate_idle_time(TF_machines, allocation[2], sim_time, dispatch_rule=dispatch_rule)
    print("="*40)
...
total_idle_time([3, 8, 4], 10000, dispatch_rule='FIFO')
total_idle_time([3, 8, 4], 10000, dispatch_rule='LIFO')
total_idle_time([3, 8, 4], 10000, dispatch_rule='SPTF')